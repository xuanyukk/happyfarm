/** * 文件名：AchievementPage.vue * 作者：开发者 * 日期：2026-05-23 *
版本：v2.0.0 * 功能描述：成就管理页面，提供成就列表查询、新增、编辑和删除功能 *
更新记录： * 2026-05-23 - v1.0.0 - 初始版本创建 * 2026-05-23 - v2.0.0 - 修复
HTML 编码问题，添加分页功能，统一样式 */
<template>
