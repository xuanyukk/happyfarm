/** * 文件名：BusinessMetricsPage.vue * 作者：开发者 * 日期：2026-05-24 *
版本：v2.1.0 *
功能描述：业务指标监控页面，提供关键业务指标监控、趋势分析、预警管理等功能 *
更新记录： * 2026-05-24 - v1.0.0 - 初始版本创建 * 2026-05-24 - v2.0.0 - 修复
HTML 编码问题，统一样式风格 * 2026-06-01 - v2.1.0 -
趋势数据接入后端API动态渲染；detailMetrics从API响应提取真实数据替换硬编码0值 */
<template>
