...
-- 索引优化
CREATE INDEX IF NOT EXISTS idx_player_id ON player_behavior_log (player_id);
CREATE INDEX IF NOT EXISTS idx_behavior_type ON player_behavior_log (behavior_type);
CREATE INDEX IF NOT EXISTS idx_create_time ON player_behavior_log (create_time);
...
CREATE INDEX IF NOT EXISTS idx_create_time ON system_operation_log (create_time);